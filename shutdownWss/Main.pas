...
begin
  ...
  // recortar nao precisa ser desabilitado, devo fazer isso no botao cortar
...
begin
  ...
  // no botao cortar, eu desabilitei o recortar
  recortarBtn.Enabled := True;
end;
